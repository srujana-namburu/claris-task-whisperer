...
const TaskCard: React.FC<TaskCardProps> = ({ task, onUpdate, onDelete }) => {
  ...
  return (
    <div className={`task-card animate-fade-in ${task.completed ? 'opacity-75' : ''}`}>
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-navy-100 dark:hover:bg-navy-700 transition-colors duration-200"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/20 transition-colors duration-200"
          >
      ...
      {isEditing ? (
        ...
        <div className="group">
          <h3 className={`text-lg font-medium mb-2 ${task.completed ? 'line-through text-navy-500 dark:text-navy-400' : 'text-navy-900 dark:text-navy-100'}`}>
            {task.name}
          </h3>
